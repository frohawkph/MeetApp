...
repl_print.cljs$lang$applyTo = (function (arglist__29673){
var args = cljs.core.seq(arglist__29673);
...
while (G__29674__i < G__29674__a.length) {G__29674__a[G__29674__i] = arguments[G__29674__i + 0]; ++G__29674__i;}
  args = new cljs.core.IndexedSeq(G__29674__a,0);
} 
return console_print__delegate.call(this,args);};
console_print.cljs$lang$maxFixedArity = 0;
console_print.cljs$lang$applyTo = (function (arglist__29675){
...
var G__29676__delegate = function (args){
...
return G__29676__delegate.call(this,args);};
...
return G__29676__delegate(args);
});
...
var connect__delegate = function (repl_server_url,p__29679){
var map__29682 = p__29679;
...
var print = cljs.core.get.call(null,map__29682__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__29682__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__29682__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__29682__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__29682__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__29683 = cljs.reader.read_string.call(null,evt.message);
var map__29683__$1 = ((cljs.core.seq_QMARK_.call(null,map__29683))?cljs.core.apply.call(null,cljs.core.hash_map,map__29683):map__29683);
var message = map__29683__$1;
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.filter.call(null,((function (gntp,repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose){
return (function (name){
return (goog.dependencies_.visited[(gntp[name])]);
});})(gntp,repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose))
,cljs.core.js_keys.call(null,gntp)));
})();

goog.isProvided_ = ((function (repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose){
return (function (_){
return false;
});})(repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose))
;

goog.require = ((function (repl_connection,map__29682,map__29682__$1,print,on_close,on_error,on_open,verbose){
...
var G__29684__i = 0, G__29684__a = new Array(arguments.length -  1);
while (G__29684__i < G__29684__a.length) {G__29684__a[G__29684__i] = arguments[G__29684__i + 1]; ++G__29684__i;}
  p__29679 = new cljs.core.IndexedSeq(G__29684__a,0);
} 
return connect__delegate.call(this,repl_server_url,p__29679);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__29685){
var repl_server_url = cljs.core.first(arglist__29685);
var p__29679 = cljs.core.rest(arglist__29685);
return connect__delegate(repl_server_url,p__29679);
});
