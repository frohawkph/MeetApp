...
return cljs.core.swap_BANG_.call(null,meetapp.store.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"roster","roster",-2092272532)], null),(function (p1__17781_SHARP_){
return cljs.core.conj.call(null,p1__17781_SHARP_,name);
}));
});
meetapp.store.remove_from_roster = (function remove_from_roster(name){
return cljs.core.swap_BANG_.call(null,meetapp.store.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"roster","roster",-2092272532)], null),(function (p1__17782_SHARP_){
return cljs.core.disj.call(null,p1__17782_SHARP_,name);
}));
});
meetapp.store.add_to_queue = (function add_to_queue(name){
return cljs.core.swap_BANG_.call(null,meetapp.store.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"queue","queue",1455835879)], null),(function (p1__17783_SHARP_){
return cljs.core.conj.call(null,p1__17783_SHARP_,name);
}));
});
