...
var time_str = clojure.string.join.call(null,":",cljs.core.map.call(null,(function (p1__24032_SHARP_){
return goog.string.format("%02d",p1__24032_SHARP_);
...
return cljs.core.swap_BANG_.call(null,meetapp.core.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"roster","roster",-2092272532)], null),(function (p1__24033_SHARP_){
return cljs.core.conj.call(null,p1__24033_SHARP_,name);
}));
});
meetapp.core.remove_from_roster = (function remove_from_roster(name){
return cljs.core.swap_BANG_.call(null,meetapp.core.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"roster","roster",-2092272532)], null),(function (p1__24034_SHARP_){
return cljs.core.disj.call(null,p1__24034_SHARP_,name);
}));
});
meetapp.core.add_to_queue = (function add_to_queue(name){
return cljs.core.swap_BANG_.call(null,meetapp.core.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"queue","queue",1455835879)], null),(function (p1__24035_SHARP_){
return cljs.core.conj.call(null,p1__24035_SHARP_,name);
}));
});
meetapp.core.remove_from_queue = (function remove_from_queue(index){
return cljs.core.swap_BANG_.call(null,meetapp.core.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"queue","queue",1455835879)], null),cljs.core.partial.call(null,meetapp.lib.collections.without,index));
});
meetapp.core.next_speaker = (function next_speaker(){
meetapp.core.reset_timer.call(null);

cljs.core.reset_BANG_.call(null,meetapp.core.current_speaker,cljs.core.first.call(null,cljs.core.deref.call(null,meetapp.core.state).call(null,new cljs.core.Keyword(null,"queue","queue",1455835879))));

return meetapp.core.remove_from_queue.call(null,(0));
});
...
cljs.core.swap_BANG_.call(null,meetapp.core.state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"queue","queue",1455835879)], null),((function (from,to){
return (function (p1__24036_SHARP_){
return meetapp.lib.collections.reposition.call(null,p1__24036_SHARP_,from,to);
});})(from,to))
);
...
})], null),"Add"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.basic-list","ul.basic-list",-684973660),(function (){var iter__18083__auto__ = (function iter__24043(s__24044){
return (new cljs.core.LazySeq(null,(function (){
var s__24044__$1 = s__24044;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__24044__$1);
if(temp__4126__auto__){
var s__24044__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__24044__$2)){
var c__18081__auto__ = cljs.core.chunk_first.call(null,s__24044__$2);
var size__18082__auto__ = cljs.core.count.call(null,c__18081__auto__);
var b__24046 = cljs.core.chunk_buffer.call(null,size__18082__auto__);
if((function (){var i__24045 = (0);
while(true){
if((i__24045 < size__18082__auto__)){
var name = cljs.core._nth.call(null,c__18081__auto__,i__24045);
cljs.core.chunk_append.call(null,b__24046,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.entry","a.entry",-1521680861),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__24045,name,c__18081__auto__,size__18082__auto__,b__24046,s__24044__$2,temp__4126__auto__){
return (function (){
return meetapp.core.add_to_queue.call(null,name);
});})(i__24045,name,c__18081__auto__,size__18082__auto__,b__24046,s__24044__$2,temp__4126__auto__))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.icon-button","a.icon-button",989529593),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__24045,name,c__18081__auto__,size__18082__auto__,b__24046,s__24044__$2,temp__4126__auto__){
return (function (){
...
var name = cljs.core.first.call(null,s__24044__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.entry","a.entry",-1521680861),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (name,s__24044__$2,temp__4126__auto__){
return (function (){
return meetapp.core.add_to_queue.call(null,name);
});})(name,s__24044__$2,temp__4126__auto__))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.icon-button","a.icon-button",989529593),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (name,s__24044__$2,temp__4126__auto__){
return (function (){
return meetapp.core.remove_from_roster.call(null,name);
});})(name,s__24044__$2,temp__4126__auto__))
], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.icon-close","i.icon-close",980811899)], null)], null)], null),iter__24043.call(null,cljs.core.rest.call(null,s__24044__$2)));
}
} else {
return null;
}
...
return goog.string.caseInsensitiveContains(p1__24038_SHARP_,cljs.core.deref.call(null,meetapp.core.current_name));
});})(iter__18083__auto__))
,cljs.core.deref.call(null,meetapp.core.state).call(null,new cljs.core.Keyword(null,"roster","roster",-2092272532))):cljs.core.deref.call(null,meetapp.core.state).call(null,new cljs.core.Keyword(null,"roster","roster",-2092272532)))));
...
}),cljs.core.deref.call(null,meetapp.core.state).call(null,new cljs.core.Keyword(null,"queue","queue",1455835879))))], null)], null)], null)], null);
});
...
var action__19322__auto___24050 = (function (params__19323__auto__){
if(cljs.core.map_QMARK_.call(null,params__19323__auto__)){
var map__24048 = params__19323__auto__;
...
var vec__24049 = params__19323__auto__;
return reagent.session.put_BANG_.call(null,new cljs.core.Keyword(null,"current-page","current-page",-101294180),new cljs.core.Var(function(){return meetapp.core.home_page;},new cljs.core.Symbol("meetapp.core","home-page","meetapp.core/home-page",-493532420,null),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),cljs.core.list(cljs.core.PersistentVector.EMPTY),new cljs.core.Keyword(null,"test","test",577538877),(cljs.core.truth_(meetapp.core.home_page)?meetapp.core.home_page.cljs$lang$test:null),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Symbol(null,"home-page","home-page",-850279575,null),new cljs.core.Keyword(null,"column","column",2078222095),1,new cljs.core.Keyword(null,"line","line",212345235),81,new cljs.core.Keyword(null,"file","file",-1269645878),"src/cljs/meetapp/core.cljs",new cljs.core.Keyword(null,"doc","doc",1913296891),null,new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Symbol(null,"meetapp.core","meetapp.core",-712138258,null)], null)));
} else {
return null;
}
...
secretary.core.add_route_BANG_.call(null,"/about",action__19322__auto___24053);

meetapp.core.hook_browser_navigation_BANG_ = (function hook_browser_navigation_BANG_(){
var G__24055 = (new goog.History());
goog.events.listen(G__24055,goog.history.EventType.NAVIGATE,((function (G__24055){
return (function (event){
return secretary.core.dispatch_BANG_.call(null,event.token);
});})(G__24055))
);

G__24055.setEnabled(true);
