...
var time_str = clojure.string.join.call(null,":",cljs.core.map.call(null,(function (p1__24152_SHARP_){
return goog.string.format("%02d",p1__24152_SHARP_);
...
return cljs.core.remove.call(null,(function (p1__24153_SHARP_){
return cljs.core._EQ_.call(null,p1__24153_SHARP_,deathrow);
}),current_list_atom);
}),item);
});
...
return cljs.core.remove.call(null,(function (p1__24154_SHARP_){
return cljs.core._EQ_.call(null,p1__24154_SHARP_,deathrow);
}),current_roster);
}),name);
});
...
return meetapp.lib.collections.reposition.call(null,p1__24155_SHARP_,from,to);
});})(from,to))
);
...
})], null),"Add"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.basic-list","ul.basic-list",-684973660),(function (){var iter__18083__auto__ = (function iter__24162(s__24163){
return (new cljs.core.LazySeq(null,(function (){
var s__24163__$1 = s__24163;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__24163__$1);
if(temp__4126__auto__){
var s__24163__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__24163__$2)){
var c__18081__auto__ = cljs.core.chunk_first.call(null,s__24163__$2);
var size__18082__auto__ = cljs.core.count.call(null,c__18081__auto__);
var b__24165 = cljs.core.chunk_buffer.call(null,size__18082__auto__);
if((function (){var i__24164 = (0);
while(true){
if((i__24164 < size__18082__auto__)){
var name = cljs.core._nth.call(null,c__18081__auto__,i__24164);
cljs.core.chunk_append.call(null,b__24165,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.entry","a.entry",-1521680861),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__24164,name,c__18081__auto__,size__18082__auto__,b__24165,s__24163__$2,temp__4126__auto__){
return (function (){
return meetapp.core.add_to_queue.call(null,name);
});})(i__24164,name,c__18081__auto__,size__18082__auto__,b__24165,s__24163__$2,temp__4126__auto__))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.icon-button","a.icon-button",989529593),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__24164,name,c__18081__auto__,size__18082__auto__,b__24165,s__24163__$2,temp__4126__auto__){
return (function (){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24165),iter__24162.call(null,cljs.core.chunk_rest.call(null,s__24163__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__24165),null);
}
} else {
var name = cljs.core.first.call(null,s__24163__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.entry","a.entry",-1521680861),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (name,s__24163__$2,temp__4126__auto__){
return (function (){
return meetapp.core.add_to_queue.call(null,name);
});})(name,s__24163__$2,temp__4126__auto__))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.icon-button","a.icon-button",989529593),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (name,s__24163__$2,temp__4126__auto__){
return (function (){
return meetapp.core.remove_from_list_atom.call(null,name,meetapp.core.roster);
});})(name,s__24163__$2,temp__4126__auto__))
], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.icon-close","i.icon-close",980811899)], null)], null)], null),iter__24162.call(null,cljs.core.rest.call(null,s__24163__$2)));
}
} else {
return null;
}
...
return goog.string.caseInsensitiveContains(p1__24157_SHARP_,cljs.core.deref.call(null,meetapp.core.current_name));
});})(iter__18083__auto__))
...
secretary.core.add_route_BANG_.call(null,"/about",action__19324__auto___24172);

meetapp.core.hook_browser_navigation_BANG_ = (function hook_browser_navigation_BANG_(){
var G__24174 = (new goog.History());
goog.events.listen(G__24174,goog.history.EventType.NAVIGATE,((function (G__24174){
return (function (event){
return secretary.core.dispatch_BANG_.call(null,event.token);
});})(G__24174))
);

G__24174.setEnabled(true);
