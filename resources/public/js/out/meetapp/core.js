...
var time_str = clojure.string.join.call(null,":",cljs.core.map.call(null,(function (p1__25170_SHARP_){
return goog.string.format("%02d",p1__25170_SHARP_);
...
return cljs.core.remove.call(null,(function (p1__25171_SHARP_){
return cljs.core._EQ_.call(null,p1__25171_SHARP_,deathrow);
}),current_list_atom);
}),item);
});
...
return cljs.core.remove.call(null,(function (p1__25172_SHARP_){
return cljs.core._EQ_.call(null,p1__25172_SHARP_,deathrow);
}),current_roster);
}),name);
});
...
if(cljs.core.not_EQ_.call(null,cljs.core.deref.call(null,meetapp.core.over),event.currentTarget)){
console.log(cljs.core.deref.call(null,meetapp.core.over),event.currentTarget);
} else {
}

if(cljs.core.not_EQ_.call(null,cljs.core.deref.call(null,meetapp.core.over),event.currentTarget)){
cljs.core.reset_BANG_.call(null,meetapp.core.over,event.currentTarget);
} else {
}
...
var from_25173 = Number((cljs.core.deref.call(null,meetapp.core.dragged)["dataset"]["id"]));
var to_25174 = Number((cljs.core.deref.call(null,meetapp.core.over)["dataset"]["id"]));
console.log(from_25173,to_25174);

cljs.core.swap_BANG_.call(null,meetapp.core.queue,((function (from_25173,to_25174){
return (function (queue){
return meetapp.core.vector_swap.call(null,cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,queue),from_25173,to_25174);
});})(from_25173,to_25174))
);
...
})], null),"Add"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.basic-list","ul.basic-list",-684973660),(function (){var iter__18084__auto__ = (function iter__25181(s__25182){
return (new cljs.core.LazySeq(null,(function (){
var s__25182__$1 = s__25182;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__25182__$1);
if(temp__4126__auto__){
var s__25182__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__25182__$2)){
var c__18082__auto__ = cljs.core.chunk_first.call(null,s__25182__$2);
var size__18083__auto__ = cljs.core.count.call(null,c__18082__auto__);
var b__25184 = cljs.core.chunk_buffer.call(null,size__18083__auto__);
if((function (){var i__25183 = (0);
while(true){
if((i__25183 < size__18083__auto__)){
var name = cljs.core._nth.call(null,c__18082__auto__,i__25183);
cljs.core.chunk_append.call(null,b__25184,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.entry","a.entry",-1521680861),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__25183,name,c__18082__auto__,size__18083__auto__,b__25184,s__25182__$2,temp__4126__auto__){
return (function (){
return meetapp.core.add_to_queue.call(null,name);
});})(i__25183,name,c__18082__auto__,size__18083__auto__,b__25184,s__25182__$2,temp__4126__auto__))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.icon-button","a.icon-button",989529593),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__25183,name,c__18082__auto__,size__18083__auto__,b__25184,s__25182__$2,temp__4126__auto__){
return (function (){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25184),iter__25181.call(null,cljs.core.chunk_rest.call(null,s__25182__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25184),null);
}
} else {
var name = cljs.core.first.call(null,s__25182__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.entry","a.entry",-1521680861),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (name,s__25182__$2,temp__4126__auto__){
return (function (){
return meetapp.core.add_to_queue.call(null,name);
});})(name,s__25182__$2,temp__4126__auto__))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.icon-button","a.icon-button",989529593),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (name,s__25182__$2,temp__4126__auto__){
return (function (){
return meetapp.core.remove_from_list_atom.call(null,name,meetapp.core.roster);
});})(name,s__25182__$2,temp__4126__auto__))
], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.icon-close","i.icon-close",980811899)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),name], null)),iter__25181.call(null,cljs.core.rest.call(null,s__25182__$2)));
}
} else {
return null;
}
...
return goog.string.caseInsensitiveContains(p1__25176_SHARP_,cljs.core.deref.call(null,meetapp.core.current_name));
});})(iter__18084__auto__))
...
var action__19364__auto___25188 = (function (params__19365__auto__){
if(cljs.core.map_QMARK_.call(null,params__19365__auto__)){
var map__25186 = params__19365__auto__;
...
secretary.core.add_route_BANG_.call(null,"/about",action__19364__auto___25191);

meetapp.core.hook_browser_navigation_BANG_ = (function hook_browser_navigation_BANG_(){
var G__25193 = (new goog.History());
goog.events.listen(G__25193,goog.history.EventType.NAVIGATE,((function (G__25193){
return (function (event){
return secretary.core.dispatch_BANG_.call(null,event.token);
});})(G__25193))
);

G__25193.setEnabled(true);
