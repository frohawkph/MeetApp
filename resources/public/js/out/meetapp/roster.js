...
return cljs.core.apply.call(null,cljs.core.sorted_set,clojure.set.select.call(null,(function (p1__23515_SHARP_){
return goog.string.caseInsensitiveContains(p1__23515_SHARP_,cljs.core.deref.call(null,meetapp.store.current_name));
...
var G__23520 = meetapp.util.key_mapping.call(null,event.which);
switch (G__23520) {
case "enter":
...
if(cljs.core.boolean$.call(null,cljs.core.deref.call(null,meetapp.roster.selected_index))){
return cljs.core.swap_BANG_.call(null,meetapp.roster.selected_index,((function (G__23520,max_count,within_bounds_QMARK_,clamp,selected_name,go_home,character){
return (function (p1__23516_SHARP_){
return clamp.call(null,(0),max_count,(p1__23516_SHARP_ + (1)));
});})(G__23520,max_count,within_bounds_QMARK_,clamp,selected_name,go_home,character))
);
} else {
...
return clamp.call(null,(0),max_count,(p1__23517_SHARP_ - (1)));
});})(G__23520,max_count,within_bounds_QMARK_,clamp,selected_name,go_home,character))
);
} else {
...
cljs.core.swap_BANG_.call(null,meetapp.store.current_name,((function (G__23520,max_count,within_bounds_QMARK_,clamp,selected_name,go_home,character){
return (function (p1__23518_SHARP_){
return [cljs.core.str(p1__23518_SHARP_),cljs.core.str(character)].join('');
});})(G__23520,max_count,within_bounds_QMARK_,clamp,selected_name,go_home,character))
);

return console.log(cljs.core._EQ_.call(null,character,""));
