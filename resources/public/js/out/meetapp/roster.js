...
return cljs.core.apply.call(null,cljs.core.sorted_set,clojure.set.select.call(null,(function (p1__37174_SHARP_){
return goog.string.caseInsensitiveContains(p1__37174_SHARP_,cljs.core.deref.call(null,meetapp.store.current_name));
...
;
var G__37178 = meetapp.util.key_mapping.call(null,event.keyCode);
switch (G__37178) {
case "enter":
...
return cljs.core.swap_BANG_.call(null,meetapp.roster.selected_index,((function (G__37178,max_count,within_bounds_QMARK_,clamp,selected_name){
return (function (p1__37175_SHARP_){
return clamp.call(null,(0),max_count,(p1__37175_SHARP_ + (1)));
});})(G__37178,max_count,within_bounds_QMARK_,clamp,selected_name))
);
} else {
...
return clamp.call(null,(0),max_count,(p1__37176_SHARP_ - (1)));
});})(G__37178,max_count,within_bounds_QMARK_,clamp,selected_name))
);
} else {
...
return p1__37180_SHARP_.preventDefault();
