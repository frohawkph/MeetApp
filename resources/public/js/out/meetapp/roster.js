...
return cljs.core.apply.call(null,cljs.core.sorted_set,clojure.set.select.call(null,(function (p1__37045_SHARP_){
return goog.string.caseInsensitiveContains(p1__37045_SHARP_,cljs.core.deref.call(null,meetapp.store.current_name));
...
var x__17942__auto__ = max_v;
var y__17943__auto__ = (function (){var x__17935__auto__ = min_v;
var y__17936__auto__ = v;
...
;
var G__37049 = meetapp.util.key_mapping.call(null,event.keyCode);
switch (G__37049) {
case "enter":
if(within_bounds_QMARK_){
return meetapp.store.add_to_queue.call(null,selected_name.call(null));
} else {
return null;
}
...
case "delete":
if(within_bounds_QMARK_){
meetapp.store.remove_from_roster.call(null,selected_name.call(null));

return cljs.core.swap_BANG_.call(null,meetapp.roster.selected_index,(((cljs.core.deref.call(null,meetapp.roster.selected_index) > (0)))?cljs.core.dec:cljs.core.identity));
} else {
return null;
}
...
if(within_bounds_QMARK_){
return cljs.core.swap_BANG_.call(null,meetapp.roster.selected_index,((function (G__37049,max_count,within_bounds_QMARK_,clamp,selected_name){
return (function (p1__37046_SHARP_){
return clamp.call(null,(0),max_count,(p1__37046_SHARP_ + (1)));
});})(G__37049,max_count,within_bounds_QMARK_,clamp,selected_name))
);
} else {
...
return clamp.call(null,(0),max_count,(p1__37047_SHARP_ - (1)));
});})(G__37049,max_count,within_bounds_QMARK_,clamp,selected_name))
);
} else {
...
return p1__37051_SHARP_.preventDefault();
