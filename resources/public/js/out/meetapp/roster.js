...
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),meetapp.roster.blur_handler,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,meetapp.store.current_name),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Search or Add",new cljs.core.Keyword(null,"on-key-press","on-key-press",-399563677),meetapp.roster.keyhandler,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__35348_SHARP_){
return cljs.core.reset_BANG_.call(null,meetapp.store.current_name,meetapp.roster.get_event_value.call(null,p1__35348_SHARP_));
})], null)], null);
})], null));
});
meetapp.roster.filtered_roster = (function filtered_roster(){
return cljs.core.sort.call(null,((cljs.core.boolean$.call(null,cljs.core.deref.call(null,meetapp.store.current_name)))?cljs.core.filter.call(null,(function (p1__35349_SHARP_){
return goog.string.caseInsensitiveContains(p1__35349_SHARP_,cljs.core.deref.call(null,meetapp.store.current_name));
...
var G__35351 = meetapp.util.key_mapping.call(null,event.keyCode);
switch (G__35351) {
case "enter":
...
return p1__35353_SHARP_.preventDefault();
