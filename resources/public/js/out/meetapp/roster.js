...
return cljs.core.apply.call(null,cljs.core.sorted_set,clojure.set.select.call(null,(function (p1__34833_SHARP_){
return goog.string.caseInsensitiveContains(p1__34833_SHARP_,cljs.core.deref.call(null,meetapp.store.current_name));
...
;
var G__34837 = meetapp.util.key_mapping.call(null,event.keyCode);
switch (G__34837) {
case "enter":
...
return cljs.core.swap_BANG_.call(null,meetapp.roster.selected_index,((function (G__34837,max_count,within_bounds_QMARK_,clamp,selected_name,go_home){
return (function (p1__34834_SHARP_){
return clamp.call(null,(0),max_count,(p1__34834_SHARP_ + (1)));
});})(G__34837,max_count,within_bounds_QMARK_,clamp,selected_name,go_home))
);
} else {
...
return clamp.call(null,(0),max_count,(p1__34835_SHARP_ - (1)));
});})(G__34837,max_count,within_bounds_QMARK_,clamp,selected_name,go_home))
);
} else {
...
return p1__34839_SHARP_.preventDefault();
});})(go_home))
