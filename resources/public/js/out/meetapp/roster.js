...
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),meetapp.roster.blur_handler,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,meetapp.store.current_name),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Search or Add",new cljs.core.Keyword(null,"on-key-press","on-key-press",-399563677),meetapp.roster.keyhandler,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__35325_SHARP_){
return cljs.core.reset_BANG_.call(null,meetapp.store.current_name,meetapp.roster.get_event_value.call(null,p1__35325_SHARP_));
})], null)], null);
})], null));
});
meetapp.roster.roster_matches_input = (function roster_matches_input(){
return cljs.core.sort.call(null,((cljs.core.boolean$.call(null,cljs.core.deref.call(null,meetapp.store.current_name)))?cljs.core.filter.call(null,(function (p1__35326_SHARP_){
return goog.string.caseInsensitiveContains(p1__35326_SHARP_,cljs.core.deref.call(null,meetapp.store.current_name));
...
var max_count = (cljs.core.count.call(null,meetapp.roster.roster_matches_input.call(null)) - (1));
...
var G__35328 = meetapp.util.key_mapping.call(null,event.keyCode);
switch (G__35328) {
case "enter":
...
return p1__35330_SHARP_.preventDefault();
...
}),meetapp.roster.roster_matches_input.call(null)))], null)], null)], null);
})], null));
});
